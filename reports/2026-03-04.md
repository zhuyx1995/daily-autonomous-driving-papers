...
- 创新评分：9.1/10
- 重点图片：
  - 方法重点图：![](https://raw.githubusercontent.com/zhuyx1995/daily-autonomous-driving-papers/main/assets/2026-03-04/lad-drive-bridging-language-and-trajectory-with-action-aware-diffusion-transformers/method.png) （PDF 第1页）
- 架构图（Mermaid）：
```mermaid
flowchart LR
...
- 创新评分：9.3/10
- 重点图片：
  - 方法重点图：![](https://raw.githubusercontent.com/zhuyx1995/daily-autonomous-driving-papers/main/assets/2026-03-04/last-vla-thinking-in-latent-spatio-temporal-space-for-vision-language-action-in-autonomous-driving/method.png) （PDF 第1页）
- 架构图（Mermaid）：
```mermaid
flowchart LR
    A[视频与传感器输入] --> B[时空编码器]
...
- 创新评分：8.9/10
- 重点图片：
  - 方法重点图：![](https://raw.githubusercontent.com/zhuyx1995/daily-autonomous-driving-papers/main/assets/2026-03-04/drivecombo-benchmarking-compositional-traffic-rule-reasoning-in-autonomous-driving/method.png) （PDF 第1页）
- 架构图（Mermaid）：
```mermaid
flowchart LR
    A[真实交通规则库] --> B[组合场景生成器]
...
- 创新评分：8.6/10
- 重点图片：
  - 方法重点图：![](https://raw.githubusercontent.com/zhuyx1995/daily-autonomous-driving-papers/main/assets/2026-03-04/from-leaderboard-to-deployment-code-quality-challenges-in-av-perception-repositories/method.png) （PDF 第1页）
- 架构图（Mermaid）：
```mermaid
flowchart LR
