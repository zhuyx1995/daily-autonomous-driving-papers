...
- GitHub 链接：https://github.com/zhuyx1995/daily-autonomous-driving-papers/blob/main/reports/2026-02/2026-02-16.md
...
#### 重点图片
![storm-fig1](../assets/2026-02/2026-02-16/storm-supervised-token-reduction-for-multi-modal-llms-toward-efficient-end-to-end-autonomous-driving/fig1.png)
> 论文首页主图给出了 SToRM 总体流程：先估计 token 重要性，再通过锚点合并压缩输入。

![storm-fig2](../assets/2026-02/2026-02-16/storm-supervised-token-reduction-for-multi-modal-llms-toward-efficient-end-to-end-autonomous-driving/fig2.png)
...
#### 重点图片
![diffplace-fig1](../assets/2026-02/2026-02-16/diffplace-street-view-generation-via-place-controllable-diffusion-model-enhancing-place-recognition/fig1.png)
> 主图展示了 place-ID 控制前后，街景背景一致性的差异，是论文主张的直观证据。

![diffplace-fig2](../assets/2026-02/2026-02-16/diffplace-street-view-generation-via-place-controllable-diffusion-model-enhancing-place-recognition/fig2.png)
...
#### 重点图片
![steervla-fig1](../assets/2026-02/2026-02-16/steervla-steering-vision-language-action-models-in-long-tail-driving-scenarios/fig1.png)
> 主图展示了高层 VLM 与低层 VLA 的分层协同关系，明确了语言接口在控制闭环中的位置。

![steervla-fig2](../assets/2026-02/2026-02-16/steervla-steering-vision-language-action-models-in-long-tail-driving-scenarios/fig2.png)
...
#### 重点图片
![vecqmdp-fig1](../assets/2026-02/2026-02-16/vec-qmdp-vectorized-pomdp-planning-on-cpus-for-real-time-autonomous-driving/fig1.png)
> 方法总览图展示了从数据布局到向量化树搜索的完整执行路径。

![vecqmdp-fig2](../assets/2026-02/2026-02-16/vec-qmdp-vectorized-pomdp-planning-on-cpus-for-real-time-autonomous-driving/fig2.png)
