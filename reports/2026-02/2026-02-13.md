...
- GitHub 链接：https://github.com/zhuyx1995/daily-autonomous-driving-papers/blob/main/reports/2026-02/2026-02-13.md
...
#### 重点图片
![resworld-fig1](../assets/2026-02/2026-02-13/resworld-temporal-residual-world-model-for-end-to-end-autonomous-driving/fig1.png)
> 方法总览图：展示 TR-World 与轨迹细化的主数据流。

![resworld-fig2](../assets/2026-02/2026-02-13/resworld-temporal-residual-world-model-for-end-to-end-autonomous-driving/fig2.png)
> 关键模块图：强调动态目标残差建模路径。
...
#### 重点图片
![flowmatching-fig1](../assets/2026-02/2026-02-13/adaptive-time-step-flow-matching-for-autonomous-driving-motion-planning/fig1.png)
> Pipeline 图：说明 flow matching 与在线控制的耦合方式。

![flowmatching-fig2](../assets/2026-02/2026-02-13/adaptive-time-step-flow-matching-for-autonomous-driving-motion-planning/fig2.png)
...
#### 重点图片
![dualdrive-fig1](../assets/2026-02/2026-02-13/from-representational-complementarity-to-dual-systems-synergizing-vlm-and-vision-only-backbones-for-end-to-end-driving/fig1.png)
> 总体架构图：展示双系统的协同工作模式。
...
#### 重点图片
![auriganet-fig1](../assets/2026-02/2026-02-13/auriganet-a-real-time-multi-task-network-for-enhanced-urban-driving-perception/fig1.png)
> 架构图：突出共享主干与多头输出组织方式。
...
#### 重点图片
![ppdnn-fig1](../assets/2026-02/2026-02-13/enhancing-predictability-of-multi-tenant-dnn-inference-for-autonomous-vehicles-perception/fig1.png)
> 系统框图：展示关键帧/ROI 与调度器协同链路。

![ppdnn-fig2](../assets/2026-02/2026-02-13/enhancing-predictability-of-multi-tenant-dnn-inference-for-autonomous-vehicles-perception/fig2.png)
> 端到端流程图：强调多租户推理的数据路径。
...
#### 重点图片
![sta-fig1](../assets/2026-02/2026-02-13/spatio-temporal-attention-for-consistent-video-semantic-segmentation-in-automated-driving/fig1.png)
> 方法示意图：突出跨帧信息如何进入分割主干。

![sta-fig2](../assets/2026-02/2026-02-13/spatio-temporal-attention-for-consistent-video-semantic-segmentation-in-automated-driving/fig2.png)
> 输入示例图：展示时序帧作为联合建模输入。
...
#### 重点图片
![cyclingvqa-fig1](../assets/2026-02/2026-02-13/from-steering-to-pedalling-do-autonomous-driving-vlms-generalize-to-cyclist-assistive-spatial-perception-and-planning/fig1.png)
> 主图：给出任务背景与评测目标。

![cyclingvqa-fig2](../assets/2026-02/2026-02-13/from-steering-to-pedalling-do-autonomous-driving-vlms-generalize-to-cyclist-assistive-spatial-perception-and-planning/fig2.png)
> 任务图：展示数据构造与空间推理问题设置。
