...
- 创新评分：9/10
- 重点图片：
  - 方法/架构图：![fig1](../assets/2026-02/2026-02-20/predmapnet-future-and-historical-reasoning-for-consistent-online-hd-vectorized-map-construction/fig1.png)（2000x1067, p.8）
  - 关键结果图：![fig2](../assets/2026-02/2026-02-20/predmapnet-future-and-historical-reasoning-for-consistent-online-hd-vectorized-map-construction/fig2.png)（1990x940, p.3）
- Mermaid架构图：
```mermaid
graph TD
  A[输入感知数据] --> B[特征编码]
...
- 创新评分：8.8/10
- 重点图片：
  - 方法/架构图：![fig1](../assets/2026-02/2026-02-20/nonplanar-model-predictive-control-for-autonomous-vehicles-with-recursive-sparse-gaussian-process-dynamics/fig1.png)（898x442, p.2）
  - 关键结果图：![fig2](../assets/2026-02/2026-02-20/nonplanar-model-predictive-control-for-autonomous-vehicles-with-recursive-sparse-gaussian-process-dynamics/fig2.png)（1090x599, p.5）
- Mermaid架构图：
```mermaid
graph TD
  A[输入感知数据] --> B[特征编码]
...
- 创新评分：8.6/10
- 重点图片：
  - 方法/架构图：![fig1](../assets/2026-02/2026-02-20/scenicrules-an-autonomous-driving-benchmark-with-multi-objective-specifications-and-abstract-scenarios/fig1.png)（831x761, p.1）
  - 关键结果图：![fig2](../assets/2026-02/2026-02-20/scenicrules-an-autonomous-driving-benchmark-with-multi-objective-specifications-and-abstract-scenarios/fig2.png)（829x761, p.1）
- Mermaid架构图：
```mermaid
graph TD
  A[输入感知数据] --> B[特征编码]
