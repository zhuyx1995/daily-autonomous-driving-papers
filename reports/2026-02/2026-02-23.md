...
- 创新评分：8.8/10
- 重点图片：
  - 方法/架构图：![boreas-method](../assets/2026-02/2026-02-23/boreas-road-trip/method-1.png)（1019x978, p.6）
  - 关键结果图：![boreas-result](../assets/2026-02/2026-02-23/boreas-road-trip/result-2.png)（1019x740, p.5）
- Mermaid架构图：
```mermaid
graph TD
...
- 创新评分：9.1/10
- 重点图片：
  - 方法/架构图：![predmapnet-method](../assets/2026-02/2026-02-23/predmapnet-online-hd-map/method-1.png)（1023x501, p.3）
  - 关键结果图：![predmapnet-result](../assets/2026-02/2026-02-23/predmapnet-online-hd-map/result-2.png)（1023x562, p.8）
- Mermaid架构图：
```mermaid
graph TD
...
- 创新评分：9.0/10
- 重点图片：
  - 方法/架构图：![drivefine-method](../assets/2026-02/2026-02-23/drivefine-masked-diffusion-vla/method-1.png)（1030x634, p.3）
  - 关键结果图：![drivefine-result](../assets/2026-02/2026-02-23/drivefine-masked-diffusion-vla/result-2.png)（1054x730, p.8）
- Mermaid架构图：
```mermaid
graph TD
