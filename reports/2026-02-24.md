...
- 创新评分：9.0/10
- 重点图片：
  - 方法/架构图：![bev-method](../assets/2026-02-24/self-supervised-bev-segmentation/method-1.png)（1048x305, p.2）
  - 关键结果图：![bev-result](../assets/2026-02-24/self-supervised-bev-segmentation/result-2.png)（512x196, p.7）
- Mermaid架构图：
```mermaid
graph TD
...
- 创新评分：8.7/10
- 重点图片：
  - 方法/架构图：![deepflow-method](../assets/2026-02-24/deep-flow-anomaly-detection/method-1.png)（1078x634, p.2）
  - 关键结果图：![deepflow-result](../assets/2026-02-24/deep-flow-anomaly-detection/result-2.png)（1030x634, p.7）
- Mermaid架构图：
```mermaid
graph TD
  A[专家驾驶轨迹] --> B[PCA谱流形压缩]
...
- 创新评分：8.8/10
- 重点图片：
  - 方法/架构图：![himap-method](../assets/2026-02-24/himap-map-occupancy-prediction/method-1.png)（1050x316, p.3）
  - 关键结果图：![himap-result](../assets/2026-02-24/himap-map-occupancy-prediction/result-2.png)（1050x344, p.7）
- Mermaid架构图：
```mermaid
graph TD
  A[多帧感知输入] --> B[历史感知时序编码]
