...
- 创新评分：8.8/10
- 重点图片：
  - 方法重点图：![](https://raw.githubusercontent.com/zhuyx1995/daily-autonomous-driving-papers/main/assets/2026-03/2026-03-03/diffusionharmonizer-bridging-neural-reconstruction-and-photorealistic-simulation-with-online-di/method.png) （PDF 第1页）
- 架构图（Mermaid）：
```mermaid
flowchart LR
    A[神经渲染仿真帧] --> B[时序条件编码]
...
- 创新评分：9.0/10
- 重点图片：
  - 方法重点图：![](https://raw.githubusercontent.com/zhuyx1995/daily-autonomous-driving-papers/main/assets/2026-03/2026-03-03/tsc-topology-conditioned-stackelberg-coordination-for-multi-agent-reinforcement-learning-in-int/method.png) （PDF 第1页）
- 架构图（Mermaid）：
```mermaid
flowchart LR
    A[多车局部观测] --> B[轨迹交织拓扑提取]
...
- 创新评分：8.7/10
- 重点图片：
  - 方法重点图：![](https://raw.githubusercontent.com/zhuyx1995/daily-autonomous-driving-papers/main/assets/2026-03/2026-03-03/selfoccflow-towards-end-to-end-self-supervised-3d-occupancy-flow-prediction/method.png) （PDF 第1页）
- 架构图（Mermaid）：
```mermaid
flowchart LR
    A[多时刻相机输入] --> B[静态SDF分支]
...
- 创新评分：8.5/10
- 重点图片：
  - 方法重点图：![](https://raw.githubusercontent.com/zhuyx1995/daily-autonomous-driving-papers/main/assets/2026-03/2026-03-03/bandwidth-adaptive-cloud-assisted-360-degree-3d-perception-for-autonomous-vehicles/method.png) （PDF 第1页）
- 架构图（Mermaid）：
```mermaid
flowchart LR
