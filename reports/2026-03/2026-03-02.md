...
- 创新评分：8.9/10
- 重点图片：
  - 方法重点图：![](https://raw.githubusercontent.com/zhuyx1995/daily-autonomous-driving-papers/main/assets/2026-03/2026-03-02/risk-aware-world-model-predictive-control-for-generalizable-end-to-end-autonomous-driving/method.png) （PDF 第1页）
- 架构图（Mermaid）：
```mermaid
flowchart LR
    A[多传感器历史观测] --> B[世界模型
...
- 创新评分：9.2/10
- 重点图片：
  - 方法重点图：![](https://raw.githubusercontent.com/zhuyx1995/daily-autonomous-driving-papers/main/assets/2026-03/2026-03-02/unleashing-the-potential-of-diffusion-models-for-end-to-end-autonomous-driving/method.png) （PDF 第1页）
- 架构图（Mermaid）：
```mermaid
flowchart LR
...
- 创新评分：8.4/10
- 重点图片：
  - 方法重点图：![](https://raw.githubusercontent.com/zhuyx1995/daily-autonomous-driving-papers/main/assets/2026-03/2026-03-02/drivepts-a-progressive-learning-framework-with-textual-and-structural-enhancement-for-driv/method.png) （PDF 第1页）
- 架构图（Mermaid）：
```mermaid
flowchart LR
...
- 创新评分：8.6/10
- 重点图片：
  - 方法重点图：![](https://raw.githubusercontent.com/zhuyx1995/daily-autonomous-driving-papers/main/assets/2026-03/2026-03-02/minddriver-introducing-progressive-multimodal-reasoning-for-autonomous-driving/method.png) （PDF 第1页）
- 架构图（Mermaid）：
```mermaid
flowchart LR
    A[多模态输入
